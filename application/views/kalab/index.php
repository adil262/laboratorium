...
<div class="main-panel">
                                ...
                                <tbody>
                                    <?php foreach ($data as $b) : ?>
                                        <tr>
                                            ...
                                            <td><?= $b['email'] ?></td>
                                            <td><?= $b['nip'] ?></td>
                                            <td><abbr title="edit"><a href="" data-toggle="modal" data-target="#editKalab<?= $b['id_kalab']; ?>" class="btn btn-inverse-warning btn-sm mdi mdi-border-color"></a></abbr>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div id="formTambah" style="display:none;" class="col-md-4 stretch-card" aria-hidden="true">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('UserKalab/add') ?>" method="post">
    ...
    <?php foreach ($data as $m) { ?>
        <div class="modal fade bd-example-modal-lg" id="editKalab<?= $m['id_kalab']; ?>" tabindex="-1" role="dialog" aria-labelledby="editLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('UserKalab/update/' . $m['id_kalab']); ?>" method="post" enctype="multipart/form-data" role="form">
