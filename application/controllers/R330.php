...
class R330 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $page_data['data'] = $this->Md_r330->getId1();
        ...
        $this->load->view('lab330/index', $page_data);
    ...
    {
        $page_data['data'] = $this->Md_r330->getByLabId($id_lab);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r330->updateByLab($id_lab, $data_update);
