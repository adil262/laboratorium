...
class R317 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r317');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab Mobile Programming 1 - R.316';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r317/index';
        $config['total_rows'] = $this->Md_r317->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r317->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab317/index', $page_data);
    ...
    {
        $page_data['data'] = $this->Md_r317->getByLabId($id_lab);
