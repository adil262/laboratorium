...
class R313 extends CI_Controller
{
    ...
    {
        $page_data['page_title'] = 'Lab. Web Programming 1 - R.313';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/R313/index';
        $config['total_rows'] = $this->Md_R313->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_R313->getId1($config['per_page'], $page_data['start']);
    ...
    public function update($id_lab)
    {
        ...
        $this->Md_R313->update($id_lab, $data_update);
