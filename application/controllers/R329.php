...
class R329 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r329');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab Software Engineering - R.329';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r329/index';
        $config['total_rows'] = $this->Md_r329->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r329->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab329/index', $page_data);
    ...
    {
        $page_data['data'] = $this->Md_r329->getByLabId($id_lab);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r329->updateByLab($id_lab, $data_update);
