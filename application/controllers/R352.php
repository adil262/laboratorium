...
class R352 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r352');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab Multimedia Studio - R.352';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r352/index';
        $config['total_rows'] = $this->Md_r352->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r352->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab352/index', $page_data);
    ...
    {
        $page_data['data'] = $this->Md_r352->getByLabId($id_lab);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r352->updateByLab($id_lab, $data_update);
