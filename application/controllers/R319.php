...
class R319 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r319');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab. Data & Business Analyst - R.319';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r319/index';
        $config['total_rows'] = $this->Md_r319->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r319->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab319/index', $page_data);
    ...
    {
        $page_data['data'] = $this->Md_r319->getByLabId($id_lab);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r319->updateByLab($id_lab, $data_update);
