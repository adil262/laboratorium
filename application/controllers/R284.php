...
class R284 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/R284/index';
        $config['total_rows'] = $this->Md_R284->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_R284->getId1($config['per_page'], $page_data['start']);
    ...
    public function update($id_lab)
    {
        ...
        $this->Md_R284->update($id_lab, $data_update);
