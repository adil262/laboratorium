...
class R320 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r320');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab Big Data & AI - R.320';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r320/index';
        $config['total_rows'] = $this->Md_r320->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r320->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab320/index', $page_data);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r320->updateByLab($id_lab, $data_update);
