...
class R316 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('Md_r316');
    }
    public function index()
    {
        $page_data['page_title'] = 'Lab Game & Animation - R.316';
        ...
        //Pagination
        $config['base_url'] = 'http://localhost/laboratorium/r316/index';
        $config['total_rows'] = $this->Md_r316->countBarang();
        $config['per_page'] = 10;
        ...
        $page_data['data'] = $this->Md_r316->getId1($config['per_page'], $page_data['start']);
        ...
        $this->load->view('lab316/index', $page_data);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($uploaded_file)) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    $this->Md_r316->updateByLab($id_lab, $data_update);
